...
//si il a choisis un mois alors il rentre dans la contition
    switch (@$month) {
        case $tableauMois[0]:
            $lienImage = "view/content/images/janvier.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[1]:
            $lienImage = "view/content/images/fevrier.PNG";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[2]:
            $lienImage = "view/content/images/mars.jpg";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[3]:
            $lienImage = "view/content/images/04-avril.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[4]:
        $lienImage = "view/content/images/mai.png";
        showMonthPicture($lienImage);
        break;

        case $tableauMois[5]:
            $lienImage = "view/content/images/06-juin.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[6]:
            $lienImage = "view/content/images/07-juillet.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[7]:
            $lienImage = "view/content/images/08-aout.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[8]:
            $lienImage = "view/content/images/09-septembre.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[9]:
            $lienImage = "view/content/images/10-octobre.png";
            showMonthPicture($lienImage);
            break;

        case $tableauMois[10]:
        $lienImage = "view/content/images/11-novembre.png";
        showMonthPicture($lienImage);
        break;

        case $tableauMois[11]:
            $lienImage = "view/content/images/12-decembre.png";
            showMonthPicture($lienImage);
            break;
    }
